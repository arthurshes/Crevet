...
class CourseAdapter(private val context: Context) : RecyclerView.Adapter<CourseAdapter.CourseHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CourseHolder {
        return CourseHolder(CoursItemBinding.inflate(LayoutInflater.from(parent.context),parent,false))
    }
...
//                    tvPremium.visibility= View.VISIBLE
                    cardCourse.background = ContextCompat.getDrawable(context, R.drawable.custom_card_course_premium)
                }
